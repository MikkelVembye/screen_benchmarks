...
This repository contains all data and code behind the title and abstract screening benchmark scheme developed in Vembye, Christensen, Mølgaard, & Schytt [-@Vembye2024_gpt]. Below, we provide guidance on how to find the data, code, and analyses behind this scheme.
...
## NIPH folder
The screening data used for analyzing the screening performance in the NIPH (Norwegian Institute of Public Health) reviews is stored in the NIPH folder. The NIPH folder contains the following subfolders: 
\ 
...
All screening performances analyses from the NIPH reviews can be found in the **NIPH dada and analysis.R** file. 
