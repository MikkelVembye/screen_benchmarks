# Creating data for service learning review
library(tidyverse)
library(rvest)
library(revtools)
library(purrr)
...
# ANBO: Hertil har det fungeret fint og er kørt som det skal. Jeg har uploadet RIS og HTML-filer samt coding report. 
