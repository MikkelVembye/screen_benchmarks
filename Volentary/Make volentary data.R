...
n_in <- 
  volentary_dat |> 
  filter(final_human_decision == 1 & if_all(`Caroline Fromberg Kiehn`:`Anton Dam`, ~ !is.na(.x)) & is.na(`Trine Filges`)) |> 
  nrow()

saveRDS(n_in, "single screener data/Number of References/volentary_n_in.rds")
